        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="space-y-4 text-[var(--text-secondary)] leading-relaxed text-sm md:text-base">
              <p>
                I am a Software Engineer, specializing in building scalable,
                production-ready applications with the{" "}
                <span className="text-[var(--text-primary)] font-medium">
                  MERN stack and PostgreSQL
                </span>
                . I have hands-on experience implementing System Design
                patterns, including Redis caching, BullMQ for background tasks,
              ...
              <p>
                ...
                using Swin Transformers, achieving 98.3% accuracy on the
                HAM10000 dataset.
              </p>
              <p>
              ...
              <p>
                ...
                and robust, user-centric web systems to build the next
          ...
          >
            ...
            >
              {[
                ...
                [
                  "Interests",
                  "New Technologies, AI, Machine Learning, Data Science, Computer Vision, NLP, Deep Learning, System Design",
                ],
              ].map(([label, value]) => (
